...
public class servicioEmpleado {
    ...
    public servicioEmpleado() {
        ...
        lista.add(new Empleado(222, "Juan", "Hernandes", "Empleado", 16000000, new int[]{2, 3, 4, 2, 4}, new int[]{3, 2, 4, 2, 1}, new int[]{1, 1, 1, 1, 1}, 0));
        lista.add(new Empleado(333, "Hector", "Espitia", "Empleado", 16000000, new int[]{1, 4, 3, 4, 3}, new int[]{3, 2, 4, 2, 1}, new int[]{1, 4, 3, 4, 3}, 0));
        lista.add(new Empleado(555, "Viviana", "Forero", "Ingeniero", 5000000, new int[]{1, 4, 3, 4, 3}, new int[]{2, 1, 0, 0, 0}, new int[]{1, 4, 3, 4, 3}, 0));
    }
    ...
    public ArrayList<Empleado> comisionE(String cargoE) {
        ...
        for (Empleado e : lista) {
            suma = e.getHorasfestivas()[0]+e.getHorasfestivas()[1]+e.getHorasfestivas()[2]+e.getHorasfestivas()[3]+e.getHorasfestivas()[4];
            horasTot = suma * costo_hora;
            totalExtra = (e.getSalario()+(horasTot));
            e.setTotal(totalExtra);
        }
        return lista;
    }
     */